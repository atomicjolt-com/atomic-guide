const g = (n) => typeof n == 'string',
  ...
  Ke = /###/g,
  re = (n) => (n && n.indexOf('###') > -1 ? n.replace(Ke, '.') : n),
  oe = (n) => !n || g(n),
  K = (n, e, t) => {
    ...
    return oe(n) ? {} : { obj: n, k: re(i[s]) };
  },
  ae = (n, e, t) => {
    const { obj: i, k: s } = K(n, e, Object);
    ...
    for (; o.obj === void 0 && a.length; )
      ((r = `${a[a.length - 1]}.${r}`),
        ...
        (o = K(n, a, Object)),
        o != null && o.obj && typeof o.obj[`${o.k}.${r}`] < 'u' && (o.obj = void 0));
    o.obj[`${o.k}.${r}`] = t;
  },
  _e = (n, e, t, i) => {
    const { obj: s, k: r } = K(n, e, Object);
    ((s[r] = s[r] || []), s[r].push(t));
  },
  J = (n, e) => {
    const { obj: t, k: i } = K(n, e);
  ...
  Ie = (n, e, t) => {
    for (const i in e)
      i !== '__proto__' &&
        i !== 'constructor' &&
        (i in n
          ? g(n[i]) || n[i] instanceof String || g(e[i]) || e[i] instanceof String
            ? t && (n[i] = e[i])
            : Ie(n[i], e[i], t)
          : (n[i] = e[i]));
    return n;
  ...
  F = (n) => n.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, '\\$&');
var Be = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;', '/': '&#x2F;' };
const ze = (n) => (g(n) ? n.replace(/[&<>"'\/]/g, (e) => Be[e]) : n);
class qe {
  constructor(e) {
...
const Je = [' ', ',', '?', '!', ';'],
  ...
  Ye = (n, e, t) => {
    ...
    const s = We.getRegExp(`(${i.map((a) => (a === '?' ? '\\?' : a)).join('|')})`);
    let r = !s.test(n);
    if (!r) {
      const a = n.indexOf(t);
  ...
  G = (n, e, t = '.') => {
    ...
    for (let r = 0; r < i.length; ) {
      ...
      for (let l = r; l < i.length; ++l)
        if ((l !== r && (o += t), (o += i[l]), (a = s[o]), a !== void 0)) {
          if (['string', 'number', 'boolean'].indexOf(typeof a) > -1 && l < i.length - 1) continue;
          r += l - r + 1;
          break;
        }
      s = a;
...
class W {
  ...
  create(e) {
    return new W(this.logger, { prefix: `${this.prefix}:${e}:`, ...this.options });
  }
  clone(e) {
...
class le extends Q {
  ...
  getResource(e, t, i, s = {}) {
    ...
    e.indexOf('.') > -1
      ? (o = e.split('.'))
      : ((o = [e, t]), i && (Array.isArray(i) ? o.push(...i) : g(i) && r ? o.push(...i.split(r)) : o.push(i)));
    const l = J(this.data, o);
    return (
      !l && !t && !i && e.indexOf('.') > -1 && ((e = o[0]), (t = o[1]), (i = o.slice(2).join('.'))),
      l || !a || !g(i) ? l : G((f = (u = this.data) == null ? void 0 : u[e]) == null ? void 0 : f[t], i, r)
    );
  }
  addResource(e, t, i, s, r = { silent: !1 }) {
    ...
    (i && (o = o.concat(a ? i.split(a) : i)),
      ...
      ae(this.data, o, s),
      r.silent || this.emit('added', e, t, i, s));
  }
  addResources(e, t, i, s = { silent: !1 }) {
    for (const r in i) (g(i[r]) || Array.isArray(i[r])) && this.addResource(e, t, r, i[r], { silent: !0 });
    s.silent || this.emit('added', e, t, i);
  }
  addResourceBundle(e, t, i, s, r, a = { silent: !1, skipCopy: !1 }) {
    let o = [e, t];
...
const Ne = Symbol('i18next/PATH_KEY');
function Ze() {
  const n = [],
  ...
  return (
    (e.get = (i, s) => {
      var r;
      return ((r = t == null ? void 0 : t.revoke) == null || r.call(t), s === Ne ? n : (n.push(s), (t = Proxy.revocable(i, e)), t.proxy));
    }),
...
const ue = {},
  ce = (n) => !g(n) && typeof n != 'boolean' && typeof n != 'number';
class Y extends Q {
  constructor(e, t = {}) {
    (super(),
      Ve(['resourceStore', 'languageUtils', 'pluralResolver', 'interpolator', 'backendConnector', 'i18nFormat', 'utils'], e, this),
      (this.options = t),
      this.options.keySeparator === void 0 && (this.options.keySeparator = '.'),
      (this.logger = $.create('translator')));
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, t) {
    ...
    const a = i && e.indexOf(i) > -1,
      o =
        !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Ye(e, i, s);
    if (a && !o) {
      const l = e.match(this.interpolator.nestingRegexp);
      if (l && l.length > 0) return { key: e, namespaces: g(r) ? [r] : r };
      const u = e.split(i);
      ((i !== s || (i === s && this.options.ns.indexOf(u[0]) > -1)) && (r = u.shift()), (e = u.join(s)));
    }
  ...
  translate(e, t, i) {
    ...
    if (
      ...
      return '';
    (typeof e == 'function' && (e = X(e, { ...this.options, ...s })), Array.isArray(e) || (e = [String(e)]));
    ...
    if ((c == null ? void 0 : c.toLowerCase()) === 'cimode')
      return p
        ? r
          ? { res: `${u}${f}${o}`, usedKey: o, exactUsedKey: o, usedLng: c, usedNS: u, usedParams: this.getUsedParamsDetails(s) }
          : `${u}${f}${o}`
        : r
          ? { res: o, usedKey: o, exactUsedKey: o, usedLng: c, usedNS: u, usedParams: this.getUsedParamsDetails(s) }
          : o;
    const d = this.resolve(e, s);
    let h = d == null ? void 0 : d.res;
    const y = (d == null ? void 0 : d.usedKey) || o,
      x = (d == null ? void 0 : d.exactUsedKey) || o,
      ...
      S = s.count !== void 0 && !g(s.count),
      P = Y.hasDefaultValue(s),
      B = S ? this.pluralResolver.getSuffix(c, s.count, s) : '',
      I = s.ordinal && S ? this.pluralResolver.getSuffix(c, s.count, { ordinal: !1 }) : '',
      T = S && !s.ordinal && s.count === 0,
      w = (T && s[`defaultValue${this.options.pluralSeparator}zero`]) || s[`defaultValue${B}`] || s[`defaultValue${I}`] || s.defaultValue;
    let b = h;
    N && !h && P && (b = w);
    const Me = ce(b),
      Ue = Object.prototype.toString.apply(b);
    if (N && b && Me && O.indexOf(Ue) < 0 && !(g(L) && Array.isArray(b))) {
      if (!s.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler || this.logger.warn('accessing an object - but returnObjects options is not enabled!');
        const C = this.options.returnedObjectHandler
          ? this.options.returnedObjectHandler(y, b, { ...s, ns: l })
          : `key '${o} (${this.language})' returned an object instead of string.`;
        return r ? ((d.res = C), (d.usedParams = this.getUsedParamsDetails(s)), d) : C;
      }
      if (a) {
        ...
        for (const R in b)
          if (Object.prototype.hasOwnProperty.call(b, R)) {
            const E = `${ee}${a}${R}`;
            (P && !h
              ? (k[R] = this.translate(E, { ...s, defaultValue: ce(w) ? w[R] : void 0, joinArrays: !1, ns: l }))
              : (k[R] = this.translate(E, { ...s, joinArrays: !1, ns: l })),
              k[R] === E && (k[R] = b[R]));
          }
        h = k;
      }
    } else if (N && g(L) && Array.isArray(h)) ((h = h.join(L)), h && (h = this.extendTranslation(h, e, s, i)));
    else {
      let C = !1,
        k = !1;
      (!this.isValidLookup(h) && P && ((C = !0), (h = w)), this.isValidLookup(h) || ((k = !0), (h = o)));
      const R = (s.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && k ? void 0 : h,
        E = P && w !== h && this.options.updateMissing;
      if (k || C || E) {
        if ((this.logger.log(E ? 'updateKey' : 'missingKey', c, u, o, E ? w : h), a)) {
        ...
        if (this.options.saveMissingTo === 'fallback' && z && z[0]) for (let v = 0; v < z.length; v++) M.push(z[v]);
        else
          this.options.saveMissingTo === 'all'
            ? (M = this.languageUtils.toResolveHierarchy(s.lng || this.language))
            : M.push(s.lng || this.language);
        const te = (v, j, U) => {
          var se;
          const ie = P && U !== h ? U : R;
          (this.options.missingKeyHandler
            ? this.options.missingKeyHandler(v, u, j, ie, E, s)
            : (se = this.backendConnector) != null && se.saveMissing && this.backendConnector.saveMissing(v, u, j, ie, E, s),
            this.emit('missingKey', v, u, j, h));
        };
          ...
          (this.options.saveMissingPlurals && S
            ? M.forEach((v) => {
                ...
                (T &&
                  ...
                  j.forEach((U) => {
                    te([v], o + U, s[`defaultValue${U}`] || w);
                  }));
              })
            : te(M, o, w));
      }
      ((h = this.extendTranslation(h, e, s, d, i)),
        k && h === o && this.options.appendNamespaceToMissingKey && (h = `${u}${f}${o}`),
        (k || C) &&
          this.options.parseMissingKeyHandler &&
          (h = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${u}${f}${o}` : o, C ? h : void 0, s)));
    }
    return r ? ((d.res = h), (d.usedParams = this.getUsedParamsDetails(s)), d) : h;
  }
  extendTranslation(e, t, i, s, r) {
    ...
    if ((l = this.i18nFormat) != null && l.parse)
      ...
      const f =
        g(e) &&
        (((u = i == null ? void 0 : i.interpolation) == null ? void 0 : u.skipOnVariables) !== void 0
      ...
      if (
        ...
        (e = this.interpolator.interpolate(e, p, i.lng || this.language || s.usedLng, i)),
        f)
      ) {
        const d = e.match(this.interpolator.nestingRegexp),
          h = d && d.length;
      ...
      (!i.lng && s && s.res && (i.lng = this.language || s.usedLng),
        i.nest !== !1 &&
          (e = this.interpolator.nest(
            e,
            (...d) =>
              (r == null ? void 0 : r[0]) === d[0] && !i.context
                ? (this.logger.warn(`It seems you are nesting recursively key: ${d[0]} in key: ${t[0]}`), null)
                : this.translate(...d, t),
            i
          )),
    ...
    return (
      ...
      e.forEach((l) => {
        ...
        const p = t.count !== void 0 && !g(t.count),
          d = p && !t.ordinal && t.count === 0,
          h = t.context !== void 0 && (g(t.context) || typeof t.context == 'number') && t.context !== '',
        ...
        c.forEach((x) => {
          ...
          this.isValidLookup(i) ||
            ...
            !ue[`${y[0]}-${x}`] &&
              ...
              !((L = this.utils) != null && L.hasLoadedNamespace(o)) &&
              ((ue[`${y[0]}-${x}`] = !0),
              this.logger.warn(
                `key "${s}" for languages "${y.join(', ')}" won't get resolved as namespace "${o}" was not yet loaded`,
            ...
            y.forEach((N) => {
              ...
              a = N;
              const S = [f];
              if ((B = this.i18nFormat) != null && B.addLookupKeys) this.i18nFormat.addLookupKeys(S, f, N, x, t);
              else {
                let I;
                p && (I = this.pluralResolver.getSuffix(N, t.count, t));
                const T = `${this.options.pluralSeparator}zero`,
                  w = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
                if (
                  (p &&
                    (t.ordinal && I.indexOf(w) === 0 && S.push(f + I.replace(w, this.options.pluralSeparator)),
                    S.push(f + I),
                    d && S.push(f + T)),
                  h)
                ) {
                  ...
                  (S.push(b),
                    p &&
                      (t.ordinal && I.indexOf(w) === 0 && S.push(b + I.replace(w, this.options.pluralSeparator)),
                      S.push(b + I),
                      d && S.push(b + T)));
                }
              }
              let P;
              for (; (P = S.pop()); ) this.isValidLookup(i) || ((r = P), (i = this.getResource(N, x, P, t)));
            }));
        });
      }),
      { res: i, usedKey: s, exactUsedKey: r, usedLng: a, usedNS: o }
    );
  }
  isValidLookup(e) {
        ...
        e.forEach((i) => {
          ...
          t = this.options.supportedLngs.find((a) => {
            ...
            if (
              ...
              ((a.indexOf('-') > 0 && r.indexOf('-') < 0 && a.substring(0, a.indexOf('-')) === r) || (a.indexOf(r) === 0 && r.length > 1))
            )
              return a;
          });
        }),
...
const he = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  de = { select: (n) => (n === 1 ? 'one' : 'other'), resolvedOptions: () => ({ pluralCategories: ['one', 'other'] }) };
class Ge {
  constructor(e, t = {}) {
  ...
  getRule(e, t = {}) {
    const i = _(e === 'dev' ? 'en' : e),
      s = t.ordinal ? 'ordinal' : 'cardinal',
      r = JSON.stringify({ cleanedCode: i, type: s });
    if (r in this.pluralRulesCache) return this.pluralRulesCache[r];
    let a;
    try {
      a = new Intl.PluralRules(i, { type: s });
    } catch {
      if (!Intl) return (this.logger.error('No Intl support, please use an Intl polyfill!'), de);
  ...
  getSuffixes(e, t = {}) {
    ...
    return (
      ...
      i
        ? i
            .resolvedOptions()
            .pluralCategories.sort((s, r) => he[s] - he[r])
...
const ge = (n, e, t, i = '.', s = !0) => {
    let r = He(n, e, t);
    return (!r && s && g(t) && ((r = G(n, t, i)), r === void 0 && (r = G(e, t, i))), r);
  },
  Z = (n) => n.replace(/\$/g, '$$$$');
class Xe {
  constructor(e = {}) {
    var t;
    ((this.logger = $.create('interpolator')),
      (this.options = e),
      (this.format = ((t = e == null ? void 0 : e.interpolation) == null ? void 0 : t.format) || ((i) => i)),
      this.init(e));
  }
  init(e = {}) {
    ...
    ((this.escape = t !== void 0 ? t : ze),
      ...
      (this.nestingPrefix = p ? F(p) : d || F('$t(')),
      (this.nestingSuffix = h ? F(h) : y || F(')')),
  ...
  interpolate(e, t, i, s) {
    ...
    const l = (this.options && this.options.interpolation && this.options.interpolation.defaultVariables) || {},
      u = (h) => {
        if (h.indexOf(this.formatSeparator) < 0) {
          const L = ge(t, l, h, this.options.keySeparator, this.options.ignoreJSONStructure);
          return this.alwaysFormat ? this.format(L, void 0, i, { ...s, ...t, interpolationkey: h }) : L;
        }
        const y = h.split(this.formatSeparator),
          x = y.shift().trim(),
          O = y.join(this.formatSeparator).trim();
        return this.format(ge(t, l, x, this.options.keySeparator, this.options.ignoreJSONStructure), O, i, {
          ...s,
          ...t,
          interpolationkey: x,
        });
    ...
    this.resetRegExp();
    const f = (s == null ? void 0 : s.missingInterpolationHandler) || this.options.missingInterpolationHandler,
      c =
        ((d = s == null ? void 0 : s.interpolation) == null ? void 0 : d.skipOnVariables) !== void 0
          ? s.interpolation.skipOnVariables
          : this.options.interpolation.skipOnVariables;
    return (
      [
        { regex: this.regexpUnescape, safeValue: (h) => Z(h) },
        { regex: this.regexp, safeValue: (h) => (this.escapeValue ? Z(this.escape(h)) : Z(h)) },
      ].forEach((h) => {
        for (o = 0; (r = h.regex.exec(e)); ) {
          ...
          if (((a = u(y)), a === void 0))
            if (typeof f == 'function') {
              const O = f(e, r, s);
              a = g(O) ? O : '';
            } else if (s && Object.prototype.hasOwnProperty.call(s, y)) a = '';
            else if (c) {
              a = r[0];
              continue;
            } else (this.logger.warn(`missed to pass in variable ${y} for interpolating ${e}`), (a = ''));
          else !g(a) && !this.useRawValueToEscape && (a = ne(a));
          const x = h.safeValue(a);
          if (
            ((e = e.replace(r[0], x)),
            c ? ((h.regex.lastIndex += a.length), (h.regex.lastIndex -= r[0].length)) : (h.regex.lastIndex = 0),
            o++,
            o >= this.maxReplaces)
          )
            break;
  ...
  nest(e, t, i = {}) {
    ...
    for (; (s = this.nestingRegexp.exec(e)); ) {
      let l = [];
      ((a = { ...i }), (a = a.replace && !g(a.replace) ? a.replace : a), (a.applyPostProcessor = !1), delete a.defaultValue);
      ...
      (g(r) || (r = ne(r)),
        ...
        l.length && (r = l.reduce((f, c) => this.format(f, c, i.lng, { ...i, interpolationkey: s[1].trim() }), r.trim())),
        (e = e.replace(s[0], r)),
...
const et = (n) => {
  ...
  pe = (n) => {
    ...
    return (t, i, s) => {
      ...
      let o = e[a];
      return (o || ((o = n(_(i), s)), (e[a] = o)), o(t));
    };
  },
  tt = (n) => (e, t, i) => n(_(t), i)(e);
class it {
  constructor(e = {}) {
  ...
  init(e, t = { interpolation: {} }) {
    ...
    const i = t.cacheInBuiltFormats ? pe : tt;
    this.formats = {
      number: i((s, r) => {
  ...
  format(e, t, i, s = {}) {
    ...
    return r.reduce((o, l) => {
      var c;
      const { formatName: u, formatOptions: f } = et(l);
      if (this.formats[u]) {
        let p = o;
        try {
          const d = ((c = s == null ? void 0 : s.formatParams) == null ? void 0 : c[s.interpolationkey]) || {},
            h = d.locale || d.lng || s.locale || s.lng || i;
          p = this.formats[u](o, h, { ...f, ...s, ...d });
        } catch (d) {
          this.logger.warn(d);
        }
        return p;
...
class nt extends Q {
  constructor(e, t, i, s = {}) {
    ...
    (super(),
      ...
      (this.options = s),
      (this.logger = $.create('backendConnector')),
      (this.waitingReads = []),
      ...
      (this.state = {}),
      (this.queue = []),
      (a = (r = this.backend) == null ? void 0 : r.init) == null || a.call(r, i, s.backend, s));
  }
  queueLoad(e, t, i, s) {
    const r = {},
      a = {},
    ...
    return (
      e.forEach((u) => {
        ...
        (t.forEach((c) => {
          const p = `${u}|${c}`;
          !i.reload && this.store.hasResourceBundle(u, c)
            ? (this.state[p] = 2)
            : this.state[p] < 0 ||
              (this.state[p] === 1
                ? a[p] === void 0 && (a[p] = !0)
      ...
      (Object.keys(r).length || Object.keys(a).length) &&
        this.queue.push({ pending: a, pendingCount: Object.keys(a).length, loaded: {}, errors: [], callback: s }),
  ...
  loaded(e, t, i) {
    ...
    (t && this.emit('failedLoading', r, a, t),
      !t && i && this.store.addResourceBundle(r, a, i, void 0, void 0, { skipCopy: !0 }),
      (this.state[e] = t ? -1 : 2),
      t && i && (this.state[e] = 0));
    const o = {};
  ...
  read(e, t, i, s = 0, r = this.retryTimeout, a) {
    ...
    if (this.readingCalls >= this.maxParallelReads) {
      this.waitingReads.push({ lng: e, ns: t, fcName: i, tried: s, wait: r, callback: a });
      return;
    }
    this.readingCalls++;
    const o = (u, f) => {
  ...
  saveMissing(e, t, i, s, r, a = {}, o = () => {}) {
    var l, u, f, c, p;
    if (
      (u = (l = this.services) == null ? void 0 : l.utils) != null &&
      u.hasLoadedNamespace &&
      !((c = (f = this.services) == null ? void 0 : f.utils) != null && c.hasLoadedNamespace(t))
    ) {
      this.logger.warn(
    ...
    if (!(i == null || i === '')) {
      if ((p = this.backend) != null && p.create) {
        const d = { ...a, isUpdate: r },
          h = this.backend.create.bind(this.backend);
        if (h.length < 6)
          try {
            let y;
            (h.length === 5 ? (y = h(e, t, i, s, d)) : (y = h(e, t, i, s)),
              y && typeof y.then == 'function' ? y.then((x) => o(null, x)).catch(o) : o(null, y));
          } catch (y) {
            o(y);
          }
        else h(e, t, i, s, o, d);
...
const me = () => ({
    ...
    overloadTranslationOptionHandler: (n) => {
      ...
      if (
        ...
        g(n[1]) && (e.defaultValue = n[1]),
        g(n[2]) && (e.tDescription = n[2]),
  ...
  ye = (n) => {
    ...
    return (
      g(n.ns) && (n.ns = [n.ns]),
      g(n.fallbackLng) && (n.fallbackLng = [n.fallbackLng]),
      g(n.fallbackNS) && (n.fallbackNS = [n.fallbackNS]),
      ((t = (e = n.supportedLngs) == null ? void 0 : e.indexOf) == null ? void 0 : t.call(e, 'cimode')) < 0 &&
...
class H extends Q {
  ...
  init(e = {}, t) {
    ((this.isInitializing = !0),
      ...
      e.defaultNS == null && e.ns && (g(e.ns) ? (e.defaultNS = e.ns) : e.ns.indexOf('translation') < 0 && (e.defaultNS = e.ns[0])));
    const i = me();
    ((this.options = { ...i, ...this.options, ...ye(e) }),
    ...
    if (!this.options.isClone) {
      ...
      ((c.logger = $),
        ...
        (c.languageUtils = f),
        (c.pluralResolver = new Ge(f, { prepend: this.options.pluralSeparator, simplifyPluralSuffix: this.options.simplifyPluralSuffix })),
        ...
        (c.interpolator = new Xe(this.options)),
        (c.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }),
        (c.backendConnector = new nt(s(this.modules.backend), c.resourceStore, c, this.options)),
        c.backendConnector.on('*', (d, ...h) => {
          this.emit(d, ...h);
        }),
        ...
        this.modules.i18nFormat && ((c.i18nFormat = s(this.modules.i18nFormat)), c.i18nFormat.init && c.i18nFormat.init(this)),
  ...
  loadResources(e, t = q) {
    ...
    if ((typeof e == 'function' && (i = e), !this.options.resources || this.options.partialBundledLanguages)) {
      ...
      (s ? l(s) : this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach((f) => l(f)),
        (a = (r = this.options.preload) == null ? void 0 : r.forEach) == null || a.call(r, (u) => l(u)),
  ...
  use(e) {
    ...
    return (
      ...
      e.type === 'postProcessor' && Ee.addPostProcessor(e),
  ...
  changeLanguage(e, t) {
    ...
    const s = (o) => {
      ...
      a = (o) => {
        ...
        const l = g(o) ? o : o && o[0],
          u = this.store.hasLanguageSomeTranslations(l) ? l : this.services.languageUtils.getBestMatchFromCodes(g(o) ? [o] : o);
        (u &&
          (this.language || s(u),
          this.translator.language || this.translator.changeLanguage(u),
          (c = (f = this.services.languageDetector) == null ? void 0 : f.cacheUserLanguage) == null || c.call(f, u)),
    ...
    const s = (r, a, ...o) => {
      ...
      return (
        l.keyPrefix && Array.isArray(r)
          ? (f = r.map((c) => (typeof c == 'function' && (c = X(c, { ...this.options, ...a })), `${l.keyPrefix}${u}${c}`)))
          : (typeof r == 'function' && (r = X(r, { ...this.options, ...a })), (f = l.keyPrefix ? `${l.keyPrefix}${u}${r}` : r)),
        this.t(f, l)
      );
    };
  ...
  dir(e) {
    var s, r;
    if (
      (e || (e = this.resolvedLanguage || (((s = this.languages) == null ? void 0 : s.length) > 0 ? this.languages[0] : this.language)), !e)
    )
      return 'rtl';
    try {
    ...
    const t = [
      ...
      i = ((r = this.services) == null ? void 0 : r.languageUtils) || new fe(me());
    return e.toLowerCase().indexOf('-latn') > 1
      ? 'ltr'
      : t.indexOf(i.getLanguagePartFromCode(e)) > -1 || e.toLowerCase().indexOf('-arab') > 1
        ? 'rtl'
        : 'ltr';
  }
  ...
  cloneInstance(e = {}, t = q) {
    ...
    if (
      ...
      const o = Object.keys(this.store.data).reduce(
        (l, u) => ((l[u] = { ...this.store.data[u] }), (l[u] = Object.keys(l[u]).reduce((f, c) => ((f[c] = { ...l[u][c] }), f), l[u])), l),
        {}
      );
      ((r.store = new le(o, s)), (r.services.resourceStore = r.store));
    }
    return (
      (r.translator = new Y(r.services, s)),
      r.translator.on('*', (o, ...l) => {
        r.emit(o, ...l);
      }),
      r.init(s, t),
...
const m = H.createInstance();
m.createInstance = H.createInstance;
m.createInstance;
m.dir;
m.init;
m.loadResources;
...
m.loadNamespaces;
m.loadLanguages;
const { slice: ot, forEach: at } = [];
function lt(n) {
  return (
    at.call(ot.call(arguments, 1), (e) => {
...
const xe = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  ct = function (n, e) {
    const i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : { path: '/' },
  ...
  be = {
    create(n, e, t, i) {
      let s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : { path: '/', sameSite: 'strict' };
      (t && ((s.expires = new Date()), s.expires.setTime(s.expires.getTime() + t * 60 * 1e3)),
        i && (s.domain = i),
        (document.cookie = ct(n, e, s)));
    },
    read(n) {
      const e = `${n}=`,
...
var ft = {
    ...
    cacheUserLanguage(n, e) {
      let { lookupCookie: t, cookieMinutes: i, cookieDomain: s, cookieOptions: r } = e;
      t && typeof document < 'u' && be.create(t, n, i, s, r);
    },
  },
  ht = {
    name: 'querystring',
    lookup(n) {
      ...
      if (typeof window < 'u') {
        ...
        !window.location.search &&
          ((i = window.location.hash) == null ? void 0 : i.indexOf('?')) > -1 &&
  ...
  dt = {
    ...
    lookup(n) {
      var s;
      let { lookupHash: e, lookupFromHashIndex: t } = n,
        i;
      if (typeof window < 'u') {
        ...
        if (r && r.length > 2) {
          ...
          if (e) {
            ...
            for (let l = 0; l < o.length; l++) {
              const u = o[l].indexOf('=');
              u > 0 && o[l].substring(0, u) === e && (i = o[l].substring(u + 1));
            }
          }
          if (i) return i;
          if (!i && t > -1) {
            const o = r.match(/\/([a-zA-Z-]*)/g);
            return Array.isArray(o) ? ((s = o[typeof t == 'number' ? t : 0]) == null ? void 0 : s.replace('/', '')) : void 0;
          }
        }
      }
      return i;
...
const Se = () => {
  if (D !== null) return D;
  try {
    if (((D = typeof window < 'u' && window.localStorage !== null), !D)) return !1;
...
var gt = {
  ...
  lookup(n) {
    ...
    if (e && Se()) return window.localStorage.getItem(e) || void 0;
  },
  cacheUserLanguage(n, e) {
    let { lookupLocalStorage: t } = e;
    t && Se() && window.localStorage.setItem(t, n);
  },
};
let A = null;
const we = () => {
  if (A !== null) return A;
  try {
    if (((A = typeof window < 'u' && window.sessionStorage !== null), !A)) return !1;
    const n = 'i18next.translate.boo';
...
var pt = {
    ...
    cacheUserLanguage(n, e) {
      ...
      t && we() && window.sessionStorage.setItem(t, n);
    },
  },
  mt = {
    name: 'navigator',
    lookup(n) {
      ...
      if (typeof navigator < 'u') {
        const { languages: t, userLanguage: i, language: s } = navigator;
...
let je = !1;
try {
  (document.cookie, (je = !0));
} catch {}
const Fe = ['querystring', 'cookie', 'localStorage', 'sessionStorage', 'navigator', 'htmlTag'];
je || Fe.splice(1, 1);
const St = () => ({
  order: Fe,
...
class wt {
  ...
  init() {
    ...
    ((this.services = e),
      (this.options = lt(t, this.options || {}, St())),
  ...
  detect() {
    ...
    return (
      ...
      (t = t.filter((i) => i != null && !ut(i)).map((i) => this.options.convertDetectedLanguage(i))),
...
const De = 'aj_lti',
  vt = 'main-content';
function Pt(n) {
  return document.cookie ? document.cookie.match(`(^|;)\\s*${n.openIdCookiePrefix}` + n.state) : !1;
}
function Lt(n) {
  document.cookie = n.openIdCookiePrefix + n.state + '=1; path=/; max-age=60; SameSite=None;';
}
function Ot(n) {
  return (
    m.t(n.privacyPolicyMessage || 'We use cookies for login and security.') +
    ' ' +
    m.t("Learn more in our <a href='{{url}}' target='_blank'>privacy policy</a>.")
  );
}
function kt(n) {
  (window.open(n.relaunchInitUrl), Ae(n, { disableLaunch: !0, showRequestStorageAccess: !1, showStorageAccessDenied: !1 }));
}
function Ae(n, e) {
  const { disableLaunch: t, showRequestStorageAccess: i, showStorageAccessDenied: s } = e,
    r = document.getElementById(vt);
  if (!r) throw m.t('Could not find main-content element');
  ((r.innerHTML = `
    <div class="aj-centered-message">
      <h1 class="aj-title">
        <i class="material-icons-outlined aj-icon" aria-hidden="true">cookie_off</i>
        ${m.t('Cookies Required')}
      </h1>
      <p class="aj-text">
        ${Ot(n)} </p>
      <p class="aj-text">
        ${m.t('Please click the button below to reload in a new window.')}
      </p>
      <button id="button_launch_new_window" class="aj-btn aj-btn--blue" ${t ? 'disabled=""' : ''} >
        ${m.t('Open in a new window')}
      </button>
      </a>
      ${
        i
        ...
        <div id="request_storage_access">
          <p class="aj-text">
            ${m.t("If you have used this application before, your browser may allow you to <a id='request_storage_access_link' href='#'>enable cookies</a> and prevent this message in the future.")}
          </p>
        </div>
      `
          : ''
      ...
      <div id="request_storage_access_error" class="u-flex">
        ...
        <p class="aj-text">
        ${m.t("The browser prevented access.  Try launching in a new window first and then clicking this option again next time. If that doesn't work check your privacy settings. Some browsers will prevent all third party cookies.")}
        </p>
      </div>
      `
          : ''
  ...
  `),
    (document.getElementById('button_launch_new_window').onclick = () => kt(n)),
    i && (document.getElementById('request_storage_access_link').onclick = () => $t(n)));
}
function Ct() {
  return new Promise((n, e) => {
    let t = window.parent || window.opener;
    const i = setTimeout(() => {
        (console.log(m.t('capabilities request timeout')), e(new Error(m.t('Timeout while waiting for capabilities response'))));
      }, 1e3),
      s = (r) => {
        if (typeof r.data == 'object' && r.data.subject === 'lti.capabilities.response' && r.data.message_id === 'aj-lti-caps') {
          if ((removeEventListener('message', s), clearTimeout(i), r.data.error)) {
            (console.error(r.data.error.code), console.error(r.data.error.message), e(new Error(r.data.errormessage)));
            return;
          }
          n(r.data.supported_messages);
        }
      };
    (window.addEventListener('message', s), t.postMessage({ subject: 'lti.capabilities', message_id: 'aj-lti-caps' }, '*'));
  });
}
async function Rt(n) {
  const e = await Ct();
  return (e && e.find((t) => t.subject == n)) || null;
}
async function Te(n) {
  let e = n.target;
  if (e == null) {
    const i = await Rt('lti.get_data');
    e = i == null ? void 0 : i.frame;
  }
  e == null && (e = '_parent');
  const t = window.parent || window.opener;
  return e === '_parent' ? t : t.frames[e] || t;
}
async function It(n, e) {
  return new Promise((t, i) => {
    let s = new URL(e.platformOIDCUrl).origin;
    e.originSupportBroken && (s = '*');
    let r = setTimeout(() => {
        (console.error('postMessage timeout'), i(new Error(m.t('Timeout while waiting for platform response'))));
      }, 2e3),
      a = (o) => {
        typeof o.data == 'object' &&
          o.data.subject === 'lti.put_data.response' &&
          o.data.message_id === n &&
          (o.origin === s || (e.originSupportBroken && s === '*')) &&
          (removeEventListener('message', a),
          clearTimeout(r),
          o.data.error && (console.error(o.data.error.code), console.error(o.data.error.message), i(new Error(o.data.errormessage))),
          t());
      };
    (window.addEventListener('message', a),
      Te(e)
        .then((o) => (o == null ? void 0 : o.postMessage({ subject: 'lti.put_data', message_id: n, key: `${De}${n}`, value: n }, s)))
        .catch((o) => {
          (console.log(m.t('Could not find target frame')), console.log(o), i(new Error(m.t('Could not find target frame'))));
        }));
  });
}
function Et() {
...
function $t(n) {
  document
    ...
    .then(() => {
      (Lt(n), window.location.replace(n.responseUrl));
    })
    .catch((e) => {
      (console.log(e), Ae(n, { showStorageAccessDenied: !0, disableLaunch: !0, showRequestStorageAccess: !1 }));
    });
}
function Nt(n, e) {
  return new Promise((t, i) => {
    ...
    e.originSupportBroken && (s = '*');
    const r = setTimeout(() => {
        (console.log(m.t('postMessage timeout')), i(new Error(m.t('Timeout while waiting for platform response'))));
      }, 2e3),
      a = (o) => {
        typeof o.data == 'object' &&
          o.data.subject === 'lti.get_data.response' &&
          o.data.message_id === n &&
          (o.origin === s || s === '*') &&
          (removeEventListener('message', a),
          clearTimeout(r),
    ...
    (window.addEventListener('message', a),
      Te(e)
        .then((o) => o.postMessage({ subject: 'lti.get_data', message_id: n, key: `${De}${n}` }, s))
        .catch((o) => {
          (console.log(m.t('Could not find target frame')), console.log(o), i(new Error(m.t('Could not find target frame'))));
        }));
  });
...
var Le;
(function (n) {
  ((n.iframe = 'iframe'), (n.window = 'window'), (n.embed = 'embed'));
})(Le || (Le = {}));
var Oe;
(function (n) {
  ((n.link = 'link'), (n.file = 'file'), (n.html = 'html'), (n.ltiResourceLink = 'ltiResourceLink'), (n.image = 'image'));
})(Oe || (Oe = {}));
var ke;
(function (n) {
  ((n.LtiResourceLinkRequest = 'LtiResourceLinkRequest'),
    (n.LtiDeepLinkingRequest = 'LtiDeepLinkingRequest'),
    (n.LtiDeepLinkingResponse = 'LtiDeepLinkingResponse'));
})(ke || (ke = {}));
var Ce;
(function (n) {
  ((n.AdministratorSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#Administrator'),
    (n.NoneSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#None'),
    (n.AccountAdminSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#AccountAdmin'),
    (n.CreatorSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#Creator'),
    (n.SysAdminSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#SysAdmin'),
    (n.SysSupportSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#SysSupport'),
    (n.UserSystemRole = 'http://purl.imsglobal.org/vocab/lis/v2/system/person#User'),
    (n.AdministratorInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Administrator'),
    (n.FacultyInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Faculty'),
    (n.GuestInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Guest'),
    (n.NoneInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#None'),
    (n.OtherInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Other'),
    (n.StaffInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Staff'),
    (n.StudentInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Student'),
    (n.AlumniInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Alumni'),
    (n.InstructorInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Instructor'),
    (n.LearnerInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Learner'),
    (n.MemberInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Member'),
    (n.MentorInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Mentor'),
    (n.ObserverInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#Observer'),
    (n.ProspectiveStudentInstitutionRole = 'http://purl.imsglobal.org/vocab/lis/v2/institution/person#ProspectiveStudent'),
    (n.AdministratorContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Administrator'),
    (n.ContentDeveloperContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#ContentDeveloper'),
    (n.InstructorContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Instructor'),
    (n.LearnerContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Learner'),
    (n.MentorContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Mentor'),
    (n.ManagerContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Manager'),
    (n.MemberContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Member'),
    (n.OfficerContextRole = 'http://purl.imsglobal.org/vocab/lis/v2/membership#Officer'));
})(Ce || (Ce = {}));
var Re;
(function (n) {
  ((n.lineItem = 'https://purl.imsglobal.org/spec/lti-ags/scope/lineitem'),
    (n.resultReadOnly = 'https://purl.imsglobal.org/spec/lti-ags/scope/result.readonly'),
    (n.score = 'https://purl.imsglobal.org/spec/lti-ags/scope/score'),
    (n.lineItemReadOnly = 'https://purl.imsglobal.org/spec/lti-ags/scope/lineitem.readonly'));
})(Re || (Re = {}));
var $e;
(function (n) {
  ((n.Active = 'Active'), (n.Inactive = 'Inactive'), (n.Deleted = 'Deleted'));
})($e || ($e = {}));
var Pe;
(function (n) {
  ((n.Timeout = 'timeout'), (n.ResponseError = 'response_error'));
})(Pe || (Pe = {}));
export { wt as B, vt as M, Et as a, Ae as b, Pt as h, m as i, Nt as l, Ot as p, It as s };
