const t=document.getElementById('main-content');if(!t)throw console.error('Main content element not found'),new Error('Main content element not found');t.innerHTML=`
