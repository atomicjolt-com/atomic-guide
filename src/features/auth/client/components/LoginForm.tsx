    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="oauth-buttons">
          <a href="/api/auth/oauth/google" className="btn btn-oauth btn-google">
          ...
          <a href="/api/auth/oauth/github" className="btn btn-oauth btn-github">
            <svg className="oauth-icon" viewBox="0 0 24 24" width="20" height="20">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-actions">
            <Link to="/auth/forgot-password" className="link-subtle">
              Forgot password?
            </Link>
          </div>
