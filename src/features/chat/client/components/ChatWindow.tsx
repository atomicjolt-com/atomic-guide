...
import { closeChat, minimizeChat, maximizeChat } from '../store/chatSlice';
import { MessageList } from './MessageList';
import { MessageInput } from './MessageInput';
import { ErrorMessage } from '@shared/client/components';
    ...
    <div className={`${styles.chatWindow} ${isMinimized ? styles.minimized : ''}`}>
      <div className={styles.chatHeader}>
        ...
        <div className={styles.chatControls}>
          {isMinimized ? (
            <button className={styles.chatControlBtn} onClick={handleMaximize} aria-label="Maximize chat">
            ...
            <button className={styles.chatControlBtn} onClick={handleMinimize} aria-label="Minimize chat">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path d="M3 8h10v2H3z" />
              </svg>
            </button>
          )}
          <button className={styles.chatControlBtn} onClick={handleClose} aria-label="Close chat">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
